...
class TumRezarvasyonlar extends StatefulWidget {
  @override
  _TumRezarvasyonlarState createState() => _TumRezarvasyonlarState();
}

class _TumRezarvasyonlarState extends State<TumRezarvasyonlar> {
  var refRezervasyon = FirebaseDatabase.instance.reference().child("Rezervasyon");
  @override
          ...
          if (event.hasData) {
            ...
            if (gelendegerler != null) {
              gelendegerler.forEach((key, nesne) {
                ...
                //Rezervasyonlar tarihe göre sıralanıyor
                                ...
                                return AlertDialog(
                                  ...
                                  actions: [
                                    FlatButton(
                                      child: Text("Sil"),
                                      onPressed: () {
                                        refRezervasyon.reference().child(rezervasyon.rezervasyon_id).remove();
